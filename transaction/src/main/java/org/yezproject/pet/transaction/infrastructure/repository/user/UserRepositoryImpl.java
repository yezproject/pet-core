...
import org.yezproject.pet.transaction.domain.user.ApprovalStatus;
import org.yezproject.pet.transaction.domain.user.Role;
import org.yezproject.pet.transaction.domain.user.User;
import org.yezproject.pet.transaction.domain.user.UserBuilder;
