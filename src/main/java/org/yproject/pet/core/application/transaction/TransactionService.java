...
public interface TransactionService {
    String create(String userId, String description, double amount, String currency);

    void modify(String userId, String transactionId, String description, double amount, String currency);
